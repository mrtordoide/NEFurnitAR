...
public class MainActivity extends AppCompatActivity {
    ...
    Drawable d;
    boolean showAR;
    boolean showChair, showSofa, showWardrobe, showBed, showCabinet;
    ...
    public void showChair(View view) {
        showChair = !showChair;
        adapter.stopListening();
        Query query;
        if(showChair){
    ...
    public void showSofa(View view) {
        showSofa = !showSofa;
        adapter.stopListening();
        Query query;
        if(showSofa){
    ...
    public void showWardrobe(View view) {
    ...
    public void showCabinet(View view) {
